...
/// <summary>
/// Result of running <see cref="MacroPlanOutputValidator"/>. Carries the validity flag and
...
/// </summary>
public sealed record MacroPlanOutputValidationResult
{
    /// <summary>
    ...
    internal MacroPlanOutputValidationResult(
        bool isValid,
    ...
    /// <see cref="MacroPlanOutputValidationViolation.None"/> when valid.
    /// </summary>
    ...
    /// </summary>
    public static MacroPlanOutputValidationResult Valid() =>
        new(isValid: true, violation: MacroPlanOutputValidationViolation.None);

    /// <summary>
    /// Returns an invalid result for the given violation kind.
    /// </summary>
    /// <param name="violation">
    /// The violation kind. Must not be <see cref="MacroPlanOutputValidationViolation.None"/> —
    /// a valid-with-violation result is a contradiction the factory rejects.
    /// </param>
    public static MacroPlanOutputValidationResult Invalid(MacroPlanOutputValidationViolation violation)
    {
        if (violation == MacroPlanOutputValidationViolation.None)
        {
        ...
        return new MacroPlanOutputValidationResult(isValid: false, violation: violation);
    }
}
