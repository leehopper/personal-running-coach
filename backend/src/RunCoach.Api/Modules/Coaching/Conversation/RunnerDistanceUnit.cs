...
/// SI conversion server-side, because distance conversions are deterministic computation
/// that belongs in the unit-tested computation layer, never in the LLM. Values are
/// explicitly numbered so reordering members never shifts the serialized integer encoding
/// (matching the <see cref="MessageIntent"/> / <see cref="Training.Adaptation.AdaptationKind"/>
/// convention).
/// </summary>
