...
public sealed class PaceCalculator : IPaceCalculator
{
    ...
    private static readonly SortedDictionary<int, PaceTableEntry> PaceTable = new()
    {
        ...
        [50] = new(301, 331, 267, 250, 231, 216),
        [51] = new(297, 327, 263, 247, 228, 213),
        [52] = new(293, 323, 260, 244, 225, 211),
        [53] = new(289, 319, 256, 241, 222, 208),
        [54] = new(285, 315, 253, 238, 219, 205),
        [55] = new(281, 311, 249, 235, 216, 203),
        [56] = new(277, 307, 246, 232, 213, 200),
        [57] = new(274, 303, 243, 229, 211, 198),
        [58] = new(270, 299, 240, 226, 208, 195),
        [59] = new(267, 295, 237, 224, 206, 193),
        [60] = new(264, 292, 234, 221, 203, 191),
        [61] = new(261, 288, 231, 219, 201, 189),
        [62] = new(258, 285, 228, 216, 199, 187),
        [63] = new(255, 282, 226, 214, 197, 185),
        [64] = new(252, 279, 223, 211, 195, 183),
        [65] = new(249, 276, 221, 209, 193, 181),
        [66] = new(247, 273, 218, 207, 191, 179),
        [67] = new(244, 270, 216, 205, 189, 177),
        [68] = new(242, 267, 214, 203, 187, 176),
        [69] = new(239, 265, 212, 201, 185, 174),
        [70] = new(237, 262, 210, 199, 183, 172),
        [71] = new(235, 259, 208, 197, 182, 170),
        [72] = new(232, 257, 206, 195, 180, 169),
        [73] = new(230, 254, 204, 193, 178, 167),
        [74] = new(228, 252, 202, 191, 177, 166),
        [75] = new(226, 250, 200, 190, 175, 164),
        [76] = new(224, 247, 198, 188, 174, 163),
        [77] = new(222, 245, 197, 186, 172, 161),
        [78] = new(220, 243, 195, 185, 171, 160),
        [79] = new(218, 241, 193, 183, 169, 159),
        [80] = new(216, 239, 192, 182, 168, 157),
        [81] = new(214, 237, 190, 180, 167, 156),
        [82] = new(212, 235, 189, 179, 165, 155),
        [83] = new(211, 233, 187, 178, 164, 154),
        [84] = new(209, 231, 186, 176, 163, 153),
        [85] = new(207, 229, 184, 175, 161, 151),
    };
