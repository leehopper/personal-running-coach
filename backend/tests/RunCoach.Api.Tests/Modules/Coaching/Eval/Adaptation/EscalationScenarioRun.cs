...
/// resolved on the final step, the count of non-absorb decisions across all
/// steps, and the per-step levels for diagnostics.
/// </summary>
/// <param name="FinalLevel">The escalation level resolved on the last step.</param>
/// <param name="EventCount">How many steps resolved above <see cref="EscalationLevel.Absorb"/>.</param>
