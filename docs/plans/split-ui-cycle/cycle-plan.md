...
- **Active Slice:** Slice 5 (Onboarding) — spec written 2026-09-05; PR-A (backend narrative field) open as #361 on `feat/slice-5-onboarding-backend`; PR-B (frontend recomposition) in flight on `feat/slice-5-onboarding-frontend`, stacked on PR-A. Slice 4 (Log & Log Book) shipped complete 2026-07-19 (PRs #302 / #304 / #306 / #308, DEC-089 D5). Slice 3 (Coach) shipped 2026-07-15 (PRs #288 / #290 / #292 / #294, DEC-091).
- **Slice ledger:**
  | # | Slice | Completed | PR |
  |---|---|---|---|
