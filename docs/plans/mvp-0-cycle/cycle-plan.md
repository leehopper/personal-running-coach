...
- **Active Slice Spec:** Sub-project 2b — `docs/specs/16-spec-slice-2b-workout-logging/` (gitignored / working-tree-only): spec + 7 Gherkin `.feature` files + `pr-strategy.md`, signed off and under implementation (PR1 + PR6a merged 2026-06-01; PR2 `workoutlog-entity` merged 2026-06-05). Sub-project 2a's spec (`docs/specs/15-spec-slice-2a-frontend-foundation/`) is fully implemented and merged; 2b's requirements remain at `docs/plans/mvp-0-cycle/slice-2-logging.md`.
