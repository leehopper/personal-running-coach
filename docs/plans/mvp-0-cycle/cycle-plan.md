...
- **Next Step:** Hand R-073 (`docs/research/prompts/batch-25a-react19-error-boundary-recovery-ux.md`) and R-074 (`docs/research/prompts/batch-25b-react19-client-otel-correlation-id.md`) to the external research agent. Once both artifacts land at `docs/research/artifacts/`, write DEC-068 (error boundary) + DEC-069 (client OTel) and then the Slice 1B spec under `docs/specs/` from the requirements doc + DEC-066/067/068/069. Slice 2 implementation does NOT start until Slice 1B merges.
