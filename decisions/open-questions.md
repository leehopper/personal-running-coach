...
| How does the AI handle injury-specific situations? | Leaning | R-010 produced the conversational approach: "concerned coach" framing — genuine care while being clear about limits and immediately offering what IS within scope. Pattern: Affirm disclosure → State limits → Recommend action → Offer what's in scope → Maintain relationship. Anti-patterns: playing doctor, dismissing, cold legal language. R-011 will add population-specific safety boundaries. |
